...
load(); // load content
	...
	function restore_options() {
	  	...
	  	chrome.storage.sync.get({
			...
			$('#instant h1:nth-child(1)').document.write(items.firstTime);
			$('#instant h1:nth-child(2)').html();
			$('#instant h1:nth-child(3)').html();
			$('#instant h1:nth-child(4)').html(); 	
	...
	function save_options() {
		...
		var timeOne = $('#instant h1:nth-child(1)').html();
		var timeTwo	= $('#instant h1:nth-child(2)').html();
		var timeThree =	$('#instant h1:nth-child(3)').html();
		var timeFour = $('#instant h1:nth-child(4)').html();
